...
export function DailyChallengeTestPage() {
  const {
    challenge,
    userChallenge,
    loading,
    addProgress,
    claimReward,
  } = useDailyChallenge(123456789, "en");
  ...
  if (!challenge) {
    return <div style={{ color: "white", padding: 20 }}>No active challenge found.</div>;
  }

  return (
    <div style={{ color: "white", padding: 20 }}>
      <h2>Daily Challenge Test</h2>
